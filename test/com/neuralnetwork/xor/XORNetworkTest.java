...
public class XORNetworkTest
{
    ...
    public void testOutput() throws Exception
    {
        ...
        output = network.generateOutput(new NVector(0f, 0f));
    ...
    public void testOutput2() throws Exception
    {
        ...
        output = network.generateOutput(new NVector(0f, 1f));
    ...
    public void testOutput3() throws Exception
    {
        ...
        output = network.generateOutput(new NVector(1f, 1f));
    ...
    public void testOutput4() throws Exception
    {
        ...
        output = network.generateOutput(new NVector(1f, 0f));
